...
jviz.modules.table.prototype.addClass = function(index, name)
{
...
jviz.modules.table.prototype.removeClass = function(index, name)
{
  //Check for undefined class name
  if(typeof name === 'undefined'){ return this; }
...
//Clear the row class
jviz.modules.table.prototype.clearClass = function()
{
